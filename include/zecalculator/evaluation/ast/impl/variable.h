...
inline Variable::ReturnType Variable::operator()(MathWorld::UnregisteredObject)
{
  return tl::unexpected(Error::undefined_variable(node));
}

inline Variable::ReturnType
  Variable::operator()(const MathWorld::ConstMathObject<GlobalConstant>& global_constant)
{
